...
export function getMenuItemsForRole(role: UserRole) {
  const menus: Record<string, any[]> = {
    ...
    admin: [
      ...
      { name: "Input Jadwal Penguji", href: "/dashboard/admin/jadwal/input", icon: "Calendar" },
    ],
    admin_super: [
      { name: "Dashboard", href: "/dashboard/admin", icon: "LayoutDashboard" },
      ...
      { name: "Monitoring Penguji", href: "/dashboard/admin/monitoring-penguji", icon: "ClipboardEdit", group: "OPERASIONAL" },
      { name: "Input Jadwal Penguji", href: "/dashboard/admin/jadwal/input", icon: "Calendar", group: "OPERASIONAL" },
