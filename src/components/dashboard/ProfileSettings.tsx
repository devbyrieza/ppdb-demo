    ...
    return (
        <div className="space-y-6 max-w-2xl pb-12">
            <div>
                ...
                <p className="text-gray-500 mt-1">Kelola informasi akun dan pengaturan keamanan Anda.</p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xs overflow-hidden">
                <div className="p-6 md:p-8 border-b border-gray-100">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">{fullName || user?.full_name}</h2>
                ...
                <div className="p-6 md:p-8 bg-gray-50/10">
                    <form onSubmit={handleSaveProfile} className="space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">No. WhatsApp (Aktif)</label>
                                <input
                                    type="text"
                                    value={phone}
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xs overflow-hidden">
                <div className="p-6 md:p-8 border-b border-gray-100">
                    ...
                    <p className="text-sm text-gray-500">Gunakan kombinasi password yang kuat dan aman.</p>
                </div>
                    ...
                    {success && (
                        <div className="mb-6 p-4 rounded-xl bg-emerald-50 text-emerald-800 border border-emerald-100 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-emerald-700/80 mt-0.5">Silakan gunakan password baru Anda saat login berikutnya.</p>
                            </div>
                        </div>
                    )}
