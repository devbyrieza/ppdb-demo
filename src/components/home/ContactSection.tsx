...
export default function ContactSection() {
  return (
    <section id="kontak" className="py-20 md:py-28 bg-white border-b border-sand-200 relative overflow-hidden">
      <Container>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-sand-50 rounded-[2.5rem] lg:rounded-[3rem] p-8 md:p-12 lg:p-16 border border-sand-200 relative overflow-hidden shadow-sm"
        >
