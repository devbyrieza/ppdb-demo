...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="group relative bg-white flex flex-col h-full rounded-2xl border border-surface-200 shadow-premium-sm hover:shadow-premium-md hover:border-primary-200 overflow-hidden transition-all duration-400"
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-6 md:p-7">
        <div className="flex items-center justify-between mb-5">
          ...
          <Quote
            className="w-8 h-8 text-secondary-100 -rotate-12 transition-colors duration-400 group-hover:text-secondary-200"
            aria-hidden
          />
        </div>
    ...
    >
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          ...
          >
            Menerapkan standar keunggulan dengan sistem terintegrasi bertaraf
            Internasional yang terbukti mencetak generasi Islami berprestasi.
          </motion.p>
