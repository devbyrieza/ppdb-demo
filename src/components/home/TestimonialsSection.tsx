    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-6 md:p-7">
        <div className="flex items-center justify-between mb-5">
          ...
          <Quote
            className="w-8 h-8 text-sand-100 -rotate-12 transition-colors duration-400 group-hover:text-sand-200"
            aria-hidden
          />
        </div>
        ...
        <div className="flex gap-1 mb-4">
          {[...Array(5)].map((_, i) => (
            <Star
              key={i}
              className="w-3.5 h-3.5 text-sand-500 fill-sand-500"
              aria-hidden
            />
          ))}
        </div>
    ...
    >
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          ...
          >
            Cerita Keberhasilan{" "}
            <span className="text-gradient-teal">Alumni & Wali Santri</span>
          </motion.h2>
