...
export default function CtaSection() {
    return (
        <section className="py-16 md:py-24 lg:py-32 bg-white relative overflow-hidden border-y border-army-100">
            <Container>
                <motion.div
                ...
                >
                    ...
                    <div className="hidden sm:block absolute -top-32 -right-32 w-64 h-64 sm:w-80 sm:h-80 md:w-[400px] md:h-[400px] bg-khaki-100/10 rounded-full blur-[80px] md:blur-[100px]" />
                    <div className="hidden sm:block absolute -bottom-32 -left-32 w-64 h-64 sm:w-80 sm:h-80 md:w-[400px] md:h-[400px] bg-army-500/20 rounded-full blur-[80px] md:blur-[100px]" />
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <p className="text-base md:text-lg lg:text-xl text-khaki-100/90 mb-8 md:mb-12 leading-relaxed font-medium text-center max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 max-w-xl mx-auto">
                            <Link href="/ppdb" className="w-full sm:w-auto flex-1">
                                <button className="w-full px-8 py-4 rounded-pill bg-white text-army-900 font-bold hover:bg-khaki-50 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 text-base md:text-lg flex items-center justify-center gap-2">
                                    Daftar Sekarang
                                </button>
                            </Link>
                        ...
                        <div className="mt-8 mb-4">
                            <span className="inline-block px-4 py-1.5 rounded-pill bg-white/10 backdrop-blur-sm border border-white/10 text-[10px] sm:text-xs text-khaki-50 font-bold uppercase tracking-widest">
