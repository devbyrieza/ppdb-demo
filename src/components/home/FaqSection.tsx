...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Ya, seluruh santri di Pesantren Sistem PPDB Modern wajib tinggal di asrama untuk mengikuti seluruh rangkaian kegiatan tarbiyah, halaqah tahfidz, dan pembelajaran kitab turots secara maksimal.",
  },
  {
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          ...
          >
            ...
            biaya, dan sistem pendidikan di Pesantren kami.
          </motion.p>
        </div>
