        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4 max-w-6xl mx-auto">
          {EXTRA_ACTIVITIES.map((item, idx) => (
            <motion.div
              ...
              className="bg-white p-6 rounded-2xl border border-secondary-200 flex flex-col items-center justify-center text-center group hover:border-primary-200 shadow-premium-sm hover:shadow-premium-md transition-all duration-400 relative overflow-hidden"
            >
