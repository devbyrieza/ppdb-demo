...
const PROGRAMS: ProgramItem[] = [
  {
    ...
    desc: "Memadukan tahfizh Al-Qur'an, kurikulum pendidikan nasional, kurikulum khas Al Fath berbasis Kitab Turots, dan entrepreneurship. Bahasa pengantar Bahasa Arab.",
    features: [
      "Target Hafalan Al-Qur'an minimal 12 Juz",
      "Kitab Turots & Ilmu Syar'i",
      "Bahasa Arab Aktif sebagai Pengantar",
      "Perpaduan Kurikulum Nasional dan Kurikulum Khas Pesantren Al-Fath",
