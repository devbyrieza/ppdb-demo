...
export default function BoardSection() {
    return (
        <section id="pembina" className="section-std">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sand-100 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 opacity-60 pointer-events-none" />
            ...
            <Container className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 max-w-6xl mx-auto">
                    {BOARD_MEMBERS.map((member, idx) => (
                        ...
                        >
                            <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-sand-50 overflow-hidden shrink-0 transition-transform duration-500 group-hover:scale-105 shadow-sm border border-sand-100">
                                {member.image ? (
                                    <div className="relative w-full h-full">
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-teal-900/0 group-hover:bg-teal-900/10 transition-colors duration-500" />
                                    </div>
                                ) : (
                                    <div className="w-full h-full flex flex-col items-center justify-center group-hover:bg-sand-100 transition-all duration-500">
                                        <User className="w-8 h-8 text-sand-300 group-hover:text-teal-600 transition-colors" />
                                    </div>
                                )}
                            ...
                            <div className="min-w-0 py-2">
                                <h4 className="font-bold text-ink-950 text-base leading-snug group-hover:text-teal-700 transition-colors">
                                    {member.name}
                                </h4>
                            </div>
                        </motion.div>
