    ...
    <main className="bg-white min-h-screen">
          ...
          <div className="grid lg:grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -bottom-6 right-0 sm:-bottom-10 sm:-right-6 md:-bottom-12 md:-right-10 z-20 bg-white p-[24px_28px] md:p-8 rounded-[24px] md:rounded-[2rem] shadow-lg border border-primary-100 max-w-[85vw] sm:max-w-[90vw] md:max-w-none"
              >
                <div className="flex items-center gap-[24px_28px] md:gap-[24px_28px]">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-primary-600 to-primary-800 rounded-[24px] md:rounded-[24px] flex items-center justify-center text-white shadow-sm shrink-0">
                  ...
                  <div>
                    ...
                    <div className="text-[9px] md:text-[10px] font-bold text-primary-900 bg-primary-50 px-2.5 py-1.5 rounded-[24px] border border-primary-100 leading-tight">
                      Sistem Terintegrasi
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              >
                ...
                <p className="font-bold text-primary-800 bg-primary-50/50 p-[24px_28px] rounded-[24px] border border-primary-100 italic text-center text-lg mt-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.2 }}
                className="grid grid-cols-1 md:grid-cols-2 gap-[24px_28px] md:gap-6 pt-4 md:pt-6"
              >
                <div className="app-card bg-white p-[24px_28px] md:p-6 flex flex-col items-start group">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-[24px] bg-orange-50 flex items-center justify-center mb-4 text-orange-600 group-hover:scale-110 transition-transform shadow-sm">
                ...
                <div className="app-card bg-white p-[24px_28px] md:p-6 flex flex-col items-start group">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-[24px] bg-primary-50 flex items-center justify-center mb-4 text-primary-600 group-hover:scale-110 transition-transform shadow-sm">
      ...
      <section className="section-std relative">
        ...
        <Container className="relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-[24px_28px] md:gap-6 lg:gap-8">
            {/* Visi */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="app-card bg-white p-[24px_28px] md:p-8 flex flex-col group h-full hover:-translate-y-1 transition-transform duration-500"
            >
              <div className="w-14 h-14 bg-primary-50 rounded-[24px] flex items-center justify-center mb-6 text-primary-600 group-hover:scale-110 transition-transform duration-500 shadow-sm">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="app-card bg-linear-to-br from-secondary-50 to-white p-[24px_28px] md:p-8 flex flex-col group h-full hover:-translate-y-1 transition-transform duration-500"
            >
              <div className="w-14 h-14 bg-secondary-50 rounded-[24px] flex items-center justify-center mb-6 text-secondary-600 group-hover:scale-110 transition-transform duration-500 shadow-sm">
              ...
              <ul className="space-y-4 md:space-y-6 flex-1">
                {[
                  ...
                  <li key={idx} className="flex gap-[24px_28px] items-center group/item">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="md:col-span-2 app-card bg-secondary-100/50 p-[24px_28px] md:p-8 lg:p-6 hover:-translate-y-1 transition-transform duration-500 group"
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-[24px_28px] sm:gap-6 mb-8">
                <div className="w-14 h-14 bg-white rounded-[24px] flex items-center justify-center text-primary-700 group-hover:scale-110 transition-transform duration-500 border border-primary-100 shadow-sm shrink-0">
              ...
              <ul className="grid md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex gap-[24px_28px] items-start group/item bg-white p-[24px_28px] rounded-[24px] border border-primary-50 shadow-sm"
                  >
      ...
      <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-white border-t border-primary-100">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-primary-900 bg-linear-to-br from-primary-800 to-primary-950 rounded-[2.5rem] md:rounded-[3rem] lg:rounded-[4rem] p-[24px_28px] md:p-8 sm:p-6 lg:p-24 relative overflow-hidden text-center shadow-lg border border-primary-700"
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-[24px_28px] justify-center items-center px-4">
