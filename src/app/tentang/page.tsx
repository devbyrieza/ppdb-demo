        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="section-std pb-0! relative overflow-hidden">
                ...
                <Container className="relative z-10 text-center">
                    ...
                    >
                        Babak Baru <br />
                        <span className="text-gradient-teal pb-2 block sm:inline">Pendidikan Qur'ani</span>
                    </motion.h1>
                ...
                <Container>
                    <div className="mb-10 lg:mb-16 text-center">
                        ...
                        >
                            ...
                            <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-teal-700">Ahlan Wa Sahlan</span>
                            <div className="w-8 h-0.5 bg-teal-600/30 rounded-full" />
                        </motion.div>
                        <h2 className="section-title text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-0">
                            ...
                            Dimulai dari <span className="text-teal-700 underline decoration-teal-500/30 underline-offset-4 md:underline-offset-8">Sini</span>
                        </h2>
                    </div>
                            ...
                            >
                                <div className="flex items-center gap-4 md:gap-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-teal-700 font-bold text-[9px] md:text-[10px] uppercase tracking-widest mb-1.5 md:mb-2">Era Baru</p>
                        ...
                        <div className="space-y-8 order-1 lg:order-2">
                            ...
                            >
                                ...
                                <div className="app-card bg-white p-5 md:p-6 flex flex-col items-start group">
                                    ...
                                    <p className="text-[9px] md:text-[10px] font-bold text-ink-500 uppercase tracking-widest">Jaringan PPDB Modern</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
                            ...
                            <ul className="space-y-4 md:space-y-6 flex-1">
                                {[
                                    ...
                                    <li key={idx} className="flex gap-4 items-center group/item">
                                        ...
                                        <span className="text-ink-800 font-bold text-[13px] md:text-sm tracking-tight group-hover/item:text-sand-700 transition-colors pt-0.5">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </motion.div>
                        ...
                        >
                            ...
                            <ul className="grid md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
                                ...
                                <li key={idx} className="flex gap-4 items-start group/item bg-white p-5 rounded-2xl border border-teal-50 shadow-sm">
