...
function VerifikasiOTPContent() {
  ...
  return (
    <div className="app-card max-w-md w-full bg-white rounded-[2.5rem] shadow-lg border border-sand-200 p-8 relative z-10">
      {/* Decorative Blur Inside Card */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-sand-50/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />

      {/* Header */}
      <div className="text-center mb-6 relative z-10">
        <div
          className={`w-20 h-20 bg-sand-50 border border-sand-200 rounded-full flex items-center justify-center mx-auto mb-4 relative shadow-sm`}
        >
          {/* Icon WhatsApp only */}
          <div className="p-3 bg-teal-700 rounded-2xl shadow-sm app-card">
      ...
      <div className="relative z-10">
        ...
        {/* Loading State */}
        {isVerifying && (
          <div className="mb-4 p-3 bg-teal-50 border border-teal-200 rounded-xl app-card shadow-sm">
            <p className="text-sm text-teal-700 font-bold flex items-center justify-center gap-2">
      ...
      <div className="space-y-3 relative z-10">
        ...
        {(otpCode.join("").length !== 6 || otpError) && (
          <button
            ...
            className="w-full py-4 px-6 font-black text-lg md:text-xl rounded-pill transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-3 shadow-md border border-transparent hover:bg-sand-100 hover:text-teal-900 bg-teal-900 text-white hover:border-teal-900 active:scale-95 app-card tracking-wide"
          >
        ...
        <button
          ...
          className="w-full py-4 px-6 border-2 font-bold rounded-pill app-card transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-2 border-teal-200 text-teal-700 bg-white hover:bg-teal-50 active:scale-95"
        >
          <RefreshCw
        ...
        <button
          ...
          disabled={isVerifying}
          className="w-full py-3 px-6 text-ink-500 text-sm font-black uppercase tracking-widest hover:text-teal-700 flex items-center justify-center gap-2 disabled:opacity-50 transition-colors"
        >
      ...
      <div className="mt-5 text-center relative z-10">
        ...
        <a
          ...
          className="text-xs bg-sand-50 text-teal-700 px-4 py-1.5 rounded-full font-black border border-sand-200 hover:bg-sand-100 transition-colors inline-block"
        >
...
function LoadingFallback() {
  return (
    <div className="app-card max-w-md w-full bg-white rounded-[2.5rem] shadow-lg border border-sand-200 p-8">
