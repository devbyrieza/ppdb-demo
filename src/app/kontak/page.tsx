...
const ContactInfoCard = ({
  ...
  <motion.div
    ...
    className="app-card bg-white p-6 sm:p-8 rounded-2xl sm:rounded-[2.5rem] border border-teal-100 shadow-sm hover:shadow-md transition-all group flex flex-col items-center text-center"
  >
    <div className="w-16 h-16 rounded-2xl bg-teal-50 flex items-center justify-center text-teal-600 mb-6 group-hover:scale-110 transition-transform shadow-sm border border-teal-100">
      <Icon className="w-8 h-8" />
    </div>
    <h3 className="text-xl font-display font-black text-teal-950 mb-3">
      {title}
    </h3>
    {href ? (
      <a
        href={href}
        className="text-lg font-bold text-teal-600 hover:text-teal-700 transition-colors break-all"
      >
        {content}
      </a>
    ) : (
...
const SocialCard = ({ social, delay = 0 }: { social: any; delay?: number }) => (
  <motion.a
    ...
    className={`app-card group flex items-center gap-4 sm:gap-5 p-4 sm:p-5 rounded-2xl sm:rounded-[2rem] bg-white border border-teal-50 shadow-sm hover:shadow-md transition-all`}
  >
    <div
      className={`w-14 h-14 rounded-2xl ${social.bgLight} flex items-center justify-center ${social.textColor} group-hover:scale-110 transition-transform shadow-sm border border-teal-50`}
    >
      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-white">
        ...
        <Container className="relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Kami Siap <br />
              <span className="text-gradient-teal">Membantu Anda</span>
            </motion.h1>
        ...
        <Container>
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-24 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-3 bg-white p-6 md:p-16 rounded-[2.5rem] md:rounded-[4rem] shadow-lg border border-teal-50 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-96 h-96 bg-teal-50/50 rounded-full blur-[100px] translate-x-1/2 -translate-y-1/2" />

              <div className="relative z-10">
                <div className="flex items-center gap-4 md:gap-5 mb-8 md:mb-12">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-teal-900 rounded-2xl md:rounded-3xl flex items-center justify-center text-white shadow-md shrink-0">
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-5 py-3 md:px-8 md:py-5 rounded-xl md:rounded-2xl bg-teal-50 border border-transparent focus:bg-white focus:border-teal-200 focus:ring-4 focus:ring-teal-50 transition-all font-bold text-ink-900 placeholder:text-ink-300 text-sm md:text-base"
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-5 py-3 md:px-8 md:py-5 rounded-xl md:rounded-2xl bg-teal-50 border border-transparent focus:bg-white focus:border-teal-200 focus:ring-4 focus:ring-teal-50 transition-all font-bold text-ink-900 placeholder:text-ink-300 text-sm md:text-base resize-none"
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 md:py-6 rounded-pill bg-teal-900 text-white font-black text-lg md:text-xl hover:bg-sand-600 shadow-md transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  Ikuti{" "}
                  <span className="text-teal-600">Media Sosial</span>
                </motion.h2>
              ...
              >
                <div className="rounded-[2rem] md:rounded-[2.5rem] overflow-hidden h-[300px] md:h-[400px] relative border border-surface-50">
                  ...
                  <div className="absolute bottom-3 left-3 md:bottom-6 md:left-6 bg-white/90 backdrop-blur-sm px-3 py-1.5 md:px-6 md:py-3 rounded-lg md:rounded-2xl shadow-md border border-teal-100 flex items-center gap-1.5 md:gap-3 z-10">
                    <MapIcon className="w-3.5 h-3.5 md:w-5 md:h-5 text-teal-600" />
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-white">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-teal-950 rounded-[2rem] md:rounded-[3rem] lg:rounded-[4rem] p-6 sm:p-8 md:p-16 lg:p-24 text-center text-white relative overflow-hidden shadow-premium-2xl"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/ppdb">
                  <button className="w-full sm:w-auto px-6 sm:px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-teal-900 font-black text-sm sm:text-base md:text-lg hover:bg-sand-100 shadow-md transition-all min-h-[48px] sm:min-h-[52px]">
                    Daftar PPDB Baru
                  </button>
                </Link>
                <a
