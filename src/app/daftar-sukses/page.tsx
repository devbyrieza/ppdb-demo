...
function DaftarSuksesContent() {
  ...
  return (
    <div className="app-card max-w-lg w-full bg-white rounded-[2.5rem] shadow-lg border border-brand-blue-100 p-8 relative overflow-hidden">
      {/* Background Blurs */}
      ...
      <div className="text-center relative z-10 mb-6 mt-4">
        <div className="relative inline-flex items-center justify-center w-24 h-24 bg-brand-blue-50 rounded-3xl border border-brand-blue-100">
      ...
      {/* Credentials Box */}
      <div className="bg-brand-blue-50 border border-brand-blue-100 rounded-[1.5rem] p-6 mb-6 relative z-10">
        ...
        {/* Nomor Pendaftaran */}
        <div className="bg-white rounded-xl border border-brand-blue-100 p-4 mb-3 shadow-sm app-card">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="p-2.5 bg-brand-blue-50 hover:bg-brand-blue-100 border border-brand-blue-200 rounded-xl transition-colors shrink-0 app-card hover:scale-105 active:scale-95"
      ...
      <div className="relative z-10 w-full mb-6">
        <button
          ...
          className="w-full py-4 md:py-5 rounded-pill bg-brand-blue-600 text-white font-black text-lg hover:bg-brand-blue-700 shadow-xl shadow-brand-blue-100 transition-all flex items-center justify-center gap-2.5 active:scale-95"
        >
      ...
      <div className="text-center relative z-10">
        ...
        <a
          ...
          className="text-xs bg-brand-blue-50 text-brand-blue-700 px-4 py-1.5 rounded-full font-black border border-brand-blue-100 hover:bg-brand-blue-100 transition-colors inline-block"
        >
...
function LoadingFallback() {
  return (
    <div className="app-card max-w-lg w-full bg-white rounded-[2.5rem] shadow-lg border border-brand-blue-100 p-8">
