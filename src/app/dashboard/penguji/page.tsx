...
export default function PengujiDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-teal-700 to-teal-900 border border-teal-600 p-8 md:p-14 text-white shadow-2xl shadow-teal-900/30 app-card">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sand-400/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="w-20 h-20 rounded-3xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-inner shrink-0 text-sand-300">
            ...
            <div>
              ...
              <p className="text-teal-100 font-bold max-w-xl text-sm md:text-lg leading-relaxed opacity-90">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {statCards.map((card, index) => (
          <div
            key={index}
            className="bg-white rounded-3xl p-5 md:p-8 border border-sand-100 shadow-xs hover:shadow-xl hover:shadow-teal-900/5 transition-all duration-500 app-card group"
          >
            <div
            ...
            <div>
              ...
              <p className="text-2xl md:text-4xl font-black text-teal-950 font-display tracking-tight leading-none">
                {card.value}
              </p>
            </div>
          </div>
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-4xl p-8 border border-sand-100 shadow-sm app-card">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-2xl font-black text-teal-950 tracking-tight font-display">
            Aksi Cepat
          </h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            ...
            className="flex items-center gap-6 p-7 bg-sand-50/50 hover:bg-sand-100/50 rounded-4xl transition-all duration-500 border border-sand-100 hover:shadow-xl hover:shadow-sand-400/10 group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Calendar className="w-20 h-20 text-teal-900" />
            </div>
            <div className="w-16 h-16 bg-sand-400 rounded-2xl flex items-center justify-center shadow-lg shadow-sand-400/20 group-hover:scale-110 group-hover:-rotate-3 transition-all shrink-0">
              <Calendar className="w-8 h-8 text-teal-950" />
            </div>
            <div>
              <p className="text-xl font-black text-teal-950 font-display">
                Lihat Jadwal
              </p>
          ...
          <Link
            ...
            className="flex items-center gap-6 p-7 bg-teal-700 hover:bg-teal-800 rounded-4xl transition-all duration-500 border border-teal-800 shadow-xl shadow-teal-900/20 hover:shadow-2xl hover:shadow-teal-900/30 group relative overflow-hidden"
          >
            ...
            <div>
              ...
              <p className="text-xs font-black text-teal-100 uppercase tracking-widest mt-1">
