      ...
      <div className="max-w-lg mx-auto p-[24px_28px] md:p-8 text-center mt-10">
        <div className="bg-white rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary/20 border p-6 md:p-10">
          ...
          <button
            ...
            className="p-[16px_20px] bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-[24px] transition-colors shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary-100"
          >
          ...
          <div key={q.id} className="bg-white p-[24px_28px] rounded-[24px] border shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div
                ...
                className={`cursor-pointer p-[24px_28px] border-2 rounded-[24px] transition-all duration-300 ${answers[q.id] === "A" ? "bg-primary-50 border-primary-500 text-primary-950 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 ring-4 ring-primary-500/5" : "border-stone-100 hover:border-primary-200 hover:bg-slate-50"}`}
              >
                <span
              ...
              <div
                ...
                className={`cursor-pointer p-[24px_28px] border-2 rounded-[24px] transition-all duration-300 ${answers[q.id] === "B" ? "bg-primary-50 border-primary-500 text-primary-950 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 ring-4 ring-primary-500/5" : "border-stone-100 hover:border-primary-200 hover:bg-slate-50"}`}
              >
                <span
      ...
      <div className="sticky bottom-4 z-50 flex gap-3">
        {page > 0 && (
          <button
            ...
            className="flex-1 py-4 bg-white border-2 border-stone-300 hover:bg-stone-50 text-stone-700 font-bold rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary/20 transition-colors"
          >
            Sebelumnya
          </button>
        )}
        {page < totalPages - 1 ? (
          <button
            onClick={handleNext}
            className="flex-1 py-4 bg-primary-600 hover:bg-primary-700 text-white font-black uppercase tracking-widest text-sm rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary-200 transition-all active:scale-95"
          >
            Lanjutkan
          </button>
        ) : (
          <button
            ...
            disabled={loading}
            className="flex-1 py-4 bg-primary-600 hover:bg-primary-700 disabled:bg-stone-300 text-white font-black uppercase tracking-widest text-sm rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary-200 transition-all active:scale-95 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
