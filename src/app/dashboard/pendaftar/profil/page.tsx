  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        {requestStatus && (
          <div
            className={`px-5 py-4 rounded-[24px] flex items-center gap-[24px_28px] transition-all hover:scale-[1.02] shadow-sm ${
          ...
          >
            <div
              className={`w-10 h-10 rounded-[24px] flex items-center justify-center shrink-0 ${
                requestStatus.status === "pending"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-panel p-6 md:p-8 rounded-[2rem] shadow-clay-md">
            <div className="flex items-center gap-[24px_28px] mb-6">
              <div className="w-12 h-12 rounded-[24px] bg-pine-100 flex items-center justify-center text-pine-600 shadow-sm">
          ...
          <div className="glass-panel p-6 md:p-8 rounded-[2rem] shadow-clay-md">
            <div className="flex items-center gap-[24px_28px] mb-6">
              <div className="w-12 h-12 rounded-[24px] bg-primary-100 flex items-center justify-center text-primary-600 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="bg-surface-50 p-[24px_28px] rounded-[24px] border border-ink-100">
              ...
              <div className="pt-6 border-t border-ink-100/50 flex flex-wrap gap-[24px_28px]">
                <div className="flex items-center gap-3 p-[16px_20px] bg-green-50 text-green-700 rounded-[24px] border border-green-100">
                  <Phone className="w-4 h-4" />
                  <span className="font-bold text-sm">
                    {data?.santri?.no_hp || "-"}
                  </span>
                </div>
                <div className="flex items-center gap-3 p-[16px_20px] bg-purple-50 text-purple-700 rounded-[24px] border border-purple-100">
          ...
          <div className="glass-panel p-6 md:p-8 rounded-[2rem] shadow-clay-md">
            <div className="flex items-center gap-[24px_28px] mb-6">
              <div className="w-12 h-12 rounded-[24px] bg-secondary-100 flex items-center justify-center text-secondary-600 shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-mesh p-1 rounded-[2.5rem] shadow-clay-lg">
            <div className="bg-white/80 backdrop-blur-xl rounded-[2.3rem] p-6 lg:p-[24px_28px] md:p-8">
              <div className="flex items-center gap-3 mb-4 text-ink-900">
                <div className="w-10 h-10 bg-surface-100 rounded-[24px] flex items-center justify-center">
              ...
              requestStatus.status === "rejected" ? (
                  ...
                  <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <button
                        ...
                        className="py-3 text-sm font-bold text-ink-500 hover:bg-surface-100 rounded-[24px] transition-colors"
                      >
                        Batal
                      </button>
                      <button
                ...
                <div className="bg-surface-50 p-6 rounded-[24px] border border-dashed border-ink-300 text-center">
