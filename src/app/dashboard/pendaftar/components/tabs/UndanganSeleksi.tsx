...
export default function UndanganSeleksiTab() {
        ...
        <div className="bg-amber-50 border-2 border-amber-200 rounded-3xl p-8 md:p-12 text-center shadow-sm">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="px-8 py-3 bg-teal-700 text-white font-black rounded-xl hover:bg-teal-800 transition-all shadow-md uppercase tracking-widest text-sm"
            >
              Cek Status Berkas
            </Link>
          </div>
  ...
  return (
    <div className="space-y-6">
      {/* ========== HEADER ========== */}
      <div className="bg-linear-to-r from-teal-700 to-teal-900 rounded-2xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10">
          <h1 className="text-2xl font-black mb-2 text-white">
            Jadwal Seleksi
          </h1>
          <p className="text-sand-100 text-sm md:text-base">
      ...
      <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
        ...
        <div className="w-full h-3 bg-surface-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-teal-500 to-teal-700 rounded-full transition-all duration-700 shadow-lg shadow-teal-500/20"
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      item.completed ? "bg-emerald-100" : "bg-teal-50"
                    }`}
                  >
                    <Icon
                      className={`w-5 h-5 ${
                  ...
                  {item.completed ? (
                    ...
                    <span className="px-2.5 py-1 bg-teal-100 text-teal-700 text-xs font-black rounded-full">
                      Tersedia
                    </span>
                  )}
                </div>
                ...
                {item.completed ? (
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-sand-400 hover:bg-sand-300 text-teal-950 text-xs font-black rounded-lg transition-colors shadow-sm border border-sand-500"
                  >
                    Mulai Tes
                  </Link>
                )}
        ...
        {data.grupB.hasSchedules && data.grupB.availableSlots.length > 0 && (
          <div className="space-y-3">
            <div className="bg-teal-50 border-l-4 border-teal-500 p-4 rounded-r-xl">
              <h3 className="font-black text-teal-900 text-sm">
                      ...
                      <div
                        ...
                        className={`bg-white rounded-xl shadow-sm p-5 border-2 transition-all ${
                          slot.isFull
                            ...
                            : "border-surface-100 hover:border-teal-300 hover:shadow-md"
                        }`}
                      >
                        ...
                        <button
                          ...
                          className="w-full py-2.5 bg-sand-400 hover:bg-sand-300 text-teal-950 font-black rounded-lg disabled:bg-surface-200 disabled:text-ink-400 disabled:cursor-not-allowed transition-all shadow-sm flex justify-center items-center gap-2 text-sm border border-sand-500"
                        >
                          {bookingId === slot.id && (
