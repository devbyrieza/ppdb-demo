    ...
    <div className="space-y-6 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-[24px] shadow-clay-md border border-white/40 overflow-hidden flex flex-col h-[700px]">
            <div className="p-6 border-b border-ink-100 flex items-center justify-between bg-secondary-50/50">
              ...
              <div className="relative w-64">
                ...
                <input
                  ...
                  className="w-full bg-white border border-ink-100 rounded-[24px] pl-9 pr-4 py-2 text-sm focus:ring-2 focus:ring-primary-600/10 outline-none"
                />
              </div>
            </div>

            <div className="flex-1 overflow-y-auto p-[24px_28px] space-y-2">
              {loading ? (
                ...
                filteredPendaftar.map((p) => (
                  <label
                    key={p.id}
                    className={`flex items-center gap-[24px_28px] p-[24px_28px] rounded-[24px] border transition-all cursor-pointer group ${
                  ...
                  >
                    <input
                      ...
                      className="w-5 h-5 rounded-[24px] border-2 border-ink-200 text-primary-700 focus:ring-primary-600/20"
                    />
            ...
            <div className="p-[24px_28px] bg-secondary-50 border-t border-ink-100 flex items-center justify-between">
              <button
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-[24px] shadow-clay-md border border-white/40 p-6 space-y-6 sticky top-28">
            <h2 className="font-bold text-ink-900 flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-secondary-50 border-none rounded-[24px] px-4 py-3 text-sm focus:ring-2 focus:ring-primary-600/10 outline-none font-medium"
                />
              </div>
            ...
            {/* Preview Card */}
            <div className="bg-secondary-50 rounded-[24px] p-[24px_28px] border border-ink-100">
              <span className="text-[10px] font-black uppercase text-ink-400 tracking-widest block mb-3">
                Pratinjau Pesan (Contoh)
              </span>
              <div className="bg-white rounded-[24px] p-[24px_28px] shadow-sm text-sm whitespace-pre-wrap font-medium text-ink-800 leading-relaxed border border-white/80">
            ...
            {results && (
              <div
                className={`p-[24px_28px] rounded-[24px] flex items-start gap-3 ${results.failed > 0 ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
              >
                {results.failed > 0 ? (
