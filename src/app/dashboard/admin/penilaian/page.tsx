  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-[24px_28px]">
        <div>
          <h1 className="text-3xl font-black text-ink-900 tracking-tight flex items-center gap-3">
            <div className="p-2 bg-primary-600 rounded-[24px] shadow-lg shadow-primary-600/20">
        ...
        <div className="flex bg-ink-50 p-1 rounded-[24px] border border-ink-100 w-fit">
          <button
            onClick={() => setActiveTab("data")}
            className={`flex items-center gap-2 px-6 py-2.5 rounded-[24px] text-sm font-bold transition-all ${
              activeTab === "data"
      ...
      {activeTab === "data" ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px_28px] mb-6">
          <div className="bg-green-50 p-6 rounded-[24px] shadow-sm border border-green-100 relative overflow-hidden">
          ...
          <div className="bg-secondary-50 p-6 rounded-[24px] shadow-sm border border-secondary-100 relative overflow-hidden">
          ...
          <div className="bg-rose-50 p-6 rounded-[24px] shadow-sm border border-rose-100 relative overflow-hidden">
          ...
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 overflow-hidden">
            <div className="p-6 border-b border-ink-50 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-[24px_28px] bg-ink-50/30">
              ...
              <div className="flex flex-wrap gap-2 w-full lg:w-auto">
                <Button
                  ...
                  className="btn-secondary flex items-center gap-2 bg-emerald-50 text-emerald-700 border-emerald-100 hover:bg-emerald-100 rounded-[24px] font-bold py-2"
                >
                ...
                <Button
                  ...
                  className="btn-secondary flex items-center gap-2 bg-purple-50 text-purple-700 border-purple-100 hover:bg-purple-100 rounded-[24px] font-bold py-2"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="rounded-[24px] border-ink-200"
                >
                    ...
                    filteredStudents.map((s) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          <span className="text-xs font-bold text-ink-600 bg-ink-100 px-2 py-1 rounded-[24px]">
                            {s.jenjang}
                          </span>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex justify-center items-center gap-1">
                            {isAdminSuper && (
                              <>
                                <button
                                  ...
                                  className="flex items-center gap-1.5 bg-amber-500 text-white px-3 py-1.5 rounded-[24px] text-[10px] font-black hover:bg-amber-600 transition-all shadow-md group-hover:scale-105"
                                >
                                  <Zap className="w-3 h-3" /> BYPASS
                                </button>
                                <button
                                  onClick={() => handleOpenAssignDialog(s)}
                                  className="flex items-center gap-1.5 bg-blue-600 text-white px-3 py-1.5 rounded-[24px] text-[10px] font-black hover:bg-blue-700 transition-all shadow-md group-hover:scale-105"
                                >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-ink-900 text-white px-3 py-1.5 rounded-[24px] text-[10px] font-black hover:bg-primary-600 transition-all shadow-md group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-white border border-ink-200 text-ink-700 px-3 py-1.5 rounded-[24px] text-[10px] font-black hover:border-primary-600 transition-all shadow-sm group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-secondary-50 border border-secondary-200 text-secondary-800 px-3 py-1.5 rounded-[24px] text-[10px] font-black hover:border-secondary-400 transition-all shadow-sm group-hover:scale-105"
                            >
            ...
            {/* Mobile Card View */}
            <div className="md:hidden space-y-3 p-[24px_28px]">
              {loading ? (
                ...
                filteredStudents.map((s) => (
                  <div
                    key={s.id}
                    className="bg-white rounded-3xl p-[24px_28px] shadow-clay-sm border border-ink-50 space-y-4"
                  >
                    ...
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-[9px] font-black text-primary-700 bg-primary-50 px-2 py-0.5 rounded-[24px] uppercase">
                            {s.jenjang}
                          </span>
                        </div>
                      ...
                      {/* Total Badge */}
                      <div className="bg-primary-600 p-[16px_20px].5 rounded-[24px] text-white text-center shrink-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                      {[
                        ...
                        <div
                          key={item.label}
                          className="bg-ink-50 rounded-[24px] p-2.5 text-center"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {isAdminSuper && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 col-span-full">
                          <button
                            onClick={() => handleOpenSkipDialog(s)}
                            className="flex items-center justify-center gap-2 bg-amber-500 text-white py-3 rounded-[24px] text-[11px] font-black shadow-lg shadow-amber-500/20 active:scale-95 transition-all"
                          >
                            <Zap className="w-3.5 h-3.5" /> BYPASS
                          </button>
                          <button
                            onClick={() => handleOpenAssignDialog(s)}
                            className="flex items-center justify-center gap-2 bg-blue-600 text-white py-3 rounded-[24px] text-[11px] font-black shadow-lg shadow-blue-500/20 active:scale-95 transition-all"
                          >
                      ...
                      <button
                        onClick={() => handleOpenInput(s, "quran")}
                        className="flex items-center justify-center gap-2 bg-ink-900 text-white py-3 rounded-[24px] text-[11px] font-black shadow-lg shadow-ink-900/10 active:scale-95 transition-all"
                      >
                        <Zap className="w-3.5 h-3.5" /> TES QUR&apos;AN
                      </button>
                      <button
                        onClick={() => handleOpenInput(s, "wawancara_santri")}
                        className="flex flex-col items-center justify-center bg-secondary-400 text-primary-900 py-2 rounded-[24px] text-[10px] sm:text-[11px] font-black shadow-lg shadow-secondary-400/20 active:scale-95 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-secondary-200 text-secondary-900 py-2 rounded-[24px] text-[10px] sm:text-[11px] font-black shadow-lg shadow-secondary-200/20 active:scale-95 transition-all"
                      >
                        <span className="flex items-center gap-1">
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-3xl p-6 shadow-clay-md border border-white/40 flex items-center gap-[24px_28px]">
              <div className="p-[24px_28px] bg-secondary-50 text-secondary-600 rounded-[24px]">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-clay-md border border-white/40 flex items-center gap-[24px_28px]">
              <div className="p-[24px_28px] bg-green-50 text-green-600 rounded-[24px]">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-clay-md border border-white/40 flex items-center gap-[24px_28px]">
              <div className="p-[24px_28px] bg-red-50 text-red-600 rounded-[24px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px_28px] mb-6">
          ...
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 overflow-hidden">
            <div className="p-[24px_28px] md:p-8 space-y-8">
              <div className="flex items-center gap-[24px_28px]">
                <div className="p-3 bg-ink-50 rounded-[24px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                <div className="p-6 bg-primary-50/30 rounded-3xl border border-primary-100/50 hover:bg-primary-50 transition-colors">
                  ...
                  <Button
                    ...
                    className="w-full bg-primary-600 hover:bg-primary-700 text-white rounded-[24px] py-6 font-black text-base shadow-lg shadow-primary-600/20"
                  >
                    {isBroadcasting
                      ? "Memproses..."
                ...
                <div className="p-6 bg-emerald-50/30 rounded-3xl border border-emerald-100/50 hover:bg-emerald-50 transition-colors">
                  ...
                  <Button
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white rounded-[24px] py-6 font-black text-base shadow-lg shadow-emerald-600/20 disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
                  >
                    {isProcessingQueue
      ...
      {assignStudent && typeof document !== "undefined" && createPortal(
        <div
          className="fixed inset-0 overflow-y-auto p-[24px_28px] overscroll-contain custom-scrollbar"
          style={{ zIndex: 99999 }}
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div
              className="fixed inset-0 bg-ink-900/60 backdrop-blur-sm transition-opacity overflow-y-auto overflow-x-hidden p-[24px_28px] overscroll-contain custom-scrollbar"
              aria-hidden="true"
            ...
            <div className="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-white/20">
              <div className="bg-white px-6 pt-8 pb-6 sm:p-[24px_28px] md:p-8">
                ...
                <div className="bg-ink-50 rounded-[24px] p-[24px_28px] mb-6 border border-ink-100">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-ink-50 border border-ink-100 rounded-[24px] px-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
                    >
              ...
              <div className="bg-ink-50 px-6 py-6 sm:px-5 md:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-ink-100">
                <Button
                  ...
                  className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white rounded-[24px] px-5 md:px-8 py-3 font-black shadow-lg shadow-primary-600/20"
                >
                  Simpan Penugasan
                </Button>
                <button
                  type="button"
                  onClick={() => setAssignStudent(null)}
                  className="mt-3 sm:mt-0 w-full sm:w-auto bg-white border border-ink-200 text-ink-600 hover:bg-ink-100 rounded-[24px] px-5 md:px-8 py-3 font-black shadow-sm transition-all"
                >
                  Batal
                </button>
              </div>
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-white/20">
              <div className="bg-white px-6 pt-8 pb-6 sm:p-[24px_28px] md:p-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-rose-50 text-rose-600 rounded-[24px]">
                ...
                <div className="space-y-4">
                  {inputType === "quran" && (
                    <div className="flex flex-col sm:flex-row gap-[24px_28px]">
                      ...
                      {[
                        ...
                        <div key={f.k}>
                          ...
                          <select
                            ...
                            className="w-full bg-ink-50 border border-ink-100 rounded-[24px] px-3 py-2 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
                          >
              ...
              <div className="bg-ink-50 px-6 py-6 sm:px-5 md:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-ink-100">
                <Button
                  ...
                  className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white rounded-[24px] px-5 md:px-8 py-3 font-black shadow-lg shadow-primary-600/20 disabled:opacity-50"
                >
