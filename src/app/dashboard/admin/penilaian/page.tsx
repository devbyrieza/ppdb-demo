    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-ink-900 tracking-tight flex items-center gap-3">
            ...
            Pusat <span className="text-teal-700">Penilaian</span>
          </h1>
        ...
        <div className="flex bg-ink-50 p-1 rounded-2xl border border-ink-100 w-fit">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${
              activeTab === "data"
                ? "bg-white text-teal-700 shadow-clay-sm"
      ...
      {activeTab === "data" ? (
              ...
              <table className="min-w-full divide-y divide-ink-100">
                <thead className="bg-ink-50/50">
                  <tr>
                    ...
                    <th className="px-3 py-4 text-center text-[10px] font-black text-teal-700 uppercase tracking-widest bg-teal-50/30">
                      Total
                    </th>
                  ...
                  {loading ? (
                    ...
                    filteredStudents.map((s) => (
                      ...
                      >
                        ...
                        {/* Total */}
                        <td className="px-3 py-4 text-center whitespace-nowrap bg-teal-50/20">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex justify-center items-center gap-1">
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-ink-900 text-white px-3 py-1.5 rounded-xl text-[10px] font-black hover:bg-teal-600 transition-all shadow-md group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-white border border-ink-200 text-ink-700 px-3 py-1.5 rounded-xl text-[10px] font-black hover:border-teal-600 transition-all shadow-sm group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-sand-50 border border-sand-200 text-sand-800 px-3 py-1.5 rounded-xl text-[10px] font-black hover:border-sand-400 transition-all shadow-sm group-hover:scale-105"
                            >
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-[9px] font-black text-teal-700 bg-teal-50 px-2 py-0.5 rounded-lg uppercase">
                            {s.jenjang}
                          </span>
                        </div>
                      ...
                      {/* Total Badge */}
                      <div className="bg-teal-600 px-4 py-2.5 rounded-2xl text-white text-center shrink-0">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-sand-400 text-teal-900 py-2 rounded-2xl text-[10px] sm:text-[11px] font-black shadow-lg shadow-sand-400/20 active:scale-95 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-sand-200 text-sand-900 py-2 rounded-2xl text-[10px] sm:text-[11px] font-black shadow-lg shadow-sand-200/20 active:scale-95 transition-all"
                      >
                        <span className="flex items-center gap-1">
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          {isProcessingQueue && (
            <div className="bg-teal-600 rounded-3xl p-6 text-white shadow-xl shadow-teal-600/20 overflow-hidden relative">
          ...
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 overflow-hidden">
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                <div className="p-6 bg-teal-50/30 rounded-3xl border border-teal-100/50 hover:bg-teal-50 transition-colors">
                  <h4 className="font-black text-teal-900 mb-2">
                    Broadcast Jadwal Seleksi
                  </h4>
                  <p className="text-xs text-teal-700/70 mb-6 font-medium leading-relaxed">
                  ...
                  <Button
                    ...
                    className="w-full bg-teal-600 hover:bg-teal-700 text-white rounded-2xl py-6 font-black text-base shadow-lg shadow-teal-600/20"
                  >
                    {isBroadcasting
                      ? "Memproses..."
            ...
            <div className="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-white/20">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          placeholder="0-100"
                          className="w-full bg-ink-50 border border-ink-100 rounded-xl px-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-teal-600/10 outline-none"
                        />
                      </div>
                      <div className="flex-1">
                        <label className="block text-xs font-black text-ink-400 uppercase tracking-wider mb-2">
                      ...
                      {[
                        ...
                        <div key={f.k}>
                          ...
                          <select
                            ...
                            className="w-full bg-ink-50 border border-ink-100 rounded-xl px-3 py-2 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-teal-600/10 outline-none"
                          >
              ...
              <div className="bg-ink-50 px-6 py-6 sm:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-ink-100">
                <Button
                  ...
                  className="w-full sm:w-auto bg-teal-600 hover:bg-teal-700 text-white rounded-2xl px-8 py-3 font-black shadow-lg shadow-teal-600/20 disabled:opacity-50"
                >
