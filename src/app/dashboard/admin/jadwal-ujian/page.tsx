  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <button
              ...
              className="flex items-center gap-3 p-[16px_20px] bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-[24px] font-black border border-indigo-200 transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-[24px] p-6 border border-indigo-100 shadow-clay-md flex items-center gap-6">
          <div className="p-[24px_28px] bg-emerald-50 rounded-[24px] border border-emerald-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-[24px_28px]">
            {loading ? (
              <div className="bg-white rounded-[24px] p-6 md:p-12 text-center border border-white/40">
                <Loader2 className="w-8 h-8 animate-spin text-purple-500 mx-auto" />
              </div>
            ) : sessions.length === 0 ? (
              <div className="bg-white rounded-[24px] p-6 md:p-12 text-center border-2 border-dashed border-ink-100">
              ...
              sessions.map((s) => (
                <div
                  key={s.id}
                  className={`group bg-white rounded-[24px] shadow-clay-md border border-white/40 p-6 flex flex-col md:flex-row md:items-center justify-between gap-[24px_28px] transition-all ${selectedPendaftarId ? "ring-2 ring-purple-100 hover:ring-purple-200" : ""}`}
                >
                  <div className="flex items-start gap-[24px_28px]">
                    <div className="w-14 h-14 rounded-[24px] bg-purple-50 flex items-center justify-center text-purple-600 shadow-inner">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-[24px_28px] mt-2">
                    ...
                    {selectedPendaftarId ? (
                      ...
                      <div className="flex flex-col gap-3 w-full md:w-64 items-end">
                        ...
                        <button
                          ...
                          disabled={assigning}
                          className="text-xs font-bold text-purple-600 hover:text-purple-800 hover:bg-purple-50 px-3 py-1.5 rounded-[24px] transition-all flex items-center gap-2"
                        >
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-white rounded-[24px] shadow-clay-md border border-white/40 overflow-hidden flex flex-col h-[600px] sticky top-28">
            <div className="p-[24px_28px] border-b border-ink-100 bg-secondary-50/50">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-ink-100 rounded-[24px] pl-9 pr-4 py-2 text-sm focus:ring-2 focus:ring-indigo-500/10 outline-none"
                />
              </div>
            </div>

            <div className="flex-1 overflow-y-auto p-[24px_28px] space-y-2 overscroll-contain custom-scrollbar">
              {filteredPendaftar.length === 0 ? (
                ...
                filteredPendaftar.map((p) => (
                  <div
                    ...
                    className={`p-[24px_28px] rounded-[24px] border transition-all cursor-pointer flex items-center justify-between group ${
            ...
            <div className="p-[24px_28px] bg-indigo-600 text-white">
      ...
      {/* Add Session Modal */}
      {showAddSession && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-[24px_28px] bg-ink-900/60 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-clay-lg border border-white overflow-hidden animate-in zoom-in-95 duration-300">
            <form onSubmit={handleCreateSession}>
              <div className="p-[24px_28px] md:p-8 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-secondary-100 rounded-[24px] transition-colors"
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-secondary-50 border-none rounded-[24px] px-4 py-3 text-sm focus:ring-2 focus:ring-purple-500/10 outline-none font-bold"
                    />
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-[24px] p-[24px_28px] border border-purple-100 flex items-start gap-3">
              ...
              <div className="px-5 md:px-8 pb-8 flex gap-3">
                <button
                  type="button"
                  onClick={() => setShowAddSession(false)}
                  className="flex-1 py-4 bg-secondary-100 hover:bg-secondary-200 text-ink-600 rounded-[24px] font-black transition-all"
                >
                  Batal
                </button>
                <button
      ...
      {sendingProgress.active && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-[24px_28px] bg-ink-900/80 backdrop-blur-sm overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-white p-[24px_28px] md:p-8 text-center animate-pulse">
            ...
            <div className="bg-secondary-50 rounded-[24px] p-[24px_28px] text-left h-32 overflow-hidden flex flex-col-reverse gap-1 border border-ink-100">
            ...
            <div className="p-[24px_28px] md:p-8 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-2 hover:bg-secondary-100 rounded-[24px]"
                >
                  <AlertCircle className="w-5 h-5 text-ink-400 rotate-45" />
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-[24px_28px] bg-indigo-50 rounded-[24px] border border-indigo-100">
                ...
                <div
                  className="flex items-center gap-3 p-[24px_28px] bg-secondary-50 rounded-[24px] cursor-pointer"
                  onClick={() => setResetFlags(!resetFlags)}
                >
                  <div
                    className={`w-6 h-6 rounded-[24px] border-2 flex items-center justify-center transition-all ${resetFlags ? "bg-indigo-600 border-indigo-600" : "bg-white border-ink-100"}`}
                  >
                    {resetFlags && (
                ...
                <div className="bg-secondary-50 rounded-[24px] p-[24px_28px] border border-secondary-100 flex items-start gap-3">
