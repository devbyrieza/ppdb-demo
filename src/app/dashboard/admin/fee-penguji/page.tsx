...
export default function RekapFeePengujiPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-[24px_28px] bg-white p-6 rounded-3xl border border-ink-100 shadow-sm">
        <div className="flex items-center gap-[24px_28px]">
          <div className="p-[24px_28px] bg-primary-50 text-primary-600 rounded-[24px]">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <Button
            onClick={fetchData}
            variant="outline"
            className="rounded-[24px] border-ink-200 text-ink-600 font-bold hover:bg-ink-50 h-11"
          >
      ...
      <div className="bg-white rounded-3xl border border-ink-100 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-ink-100 flex flex-col md:flex-row items-center justify-between gap-[24px_28px]">
          <div className="relative w-full md:max-w-md">
            ...
            <input
              ...
              className="w-full bg-ink-50 border border-ink-100 rounded-[24px] pl-11 pr-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
            />
          </div>
          <div className="flex items-center gap-[24px_28px] text-sm">
            <div className="bg-orange-50 text-orange-700 p-[16px_20px] rounded-[24px] font-bold border border-orange-100">
              Total Sesi: <span className="font-black text-lg">{totalSesiSemua}</span>
            </div>
            <div className="bg-primary-50 text-primary-700 p-[16px_20px] rounded-[24px] font-bold border border-primary-100">
