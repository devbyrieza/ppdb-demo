...
export default function PengaturanPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-white rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary/20 p-6 border-2 border-purple-100">
              ...
              {activeTahunAjaran ? (
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-[24px] p-[24px_28px] flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 bg-white text-green-600 rounded-[24px] hover:shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 transition-all border border-green-100"
                  >
      ...
      {/* Edit Modal Overlay */}
      {editingTa && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[9999] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center bg-stone-900/50 backdrop-blur-sm p-[24px_28px] overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
            ...
            <form onSubmit={handleUpdate} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={updating}
                  className="flex-1 p-[16px_20px] bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-[24px] shadow-2xl shadow-primary/30  shadow-primary/20 shadow-purple-200 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
