...
const ActionCard = ({
  ...
  const CardContent = (
    ...
    >
      ...
      {!disabled && (
        <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-teal-600 group-hover:translate-x-2 transition-transform">
...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden pb-24">
      ...
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-50/20 rounded-full blur-[140px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      ...
      <Container className="pt-16 md:pt-24 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            >
              <div className="absolute top-0 right-0 w-80 h-80 bg-teal-500/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <motion.div
              ...
              className="bg-white p-12 rounded-[4rem] shadow-2xl shadow-teal-900/5 border border-ink-50 flex flex-col items-center text-center relative overflow-hidden group"
            >
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-teal-600 to-sand-500" />
            ...
            <motion.div
              ...
              className="bg-teal-950 p-12 rounded-[4rem] shadow-2xl relative overflow-hidden group"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-sand-400" />
              <div className="absolute bottom-0 right-0 w-40 h-40 bg-teal-500/10 rounded-full blur-[60px] translate-y-1/2 translate-x-1/2 pointer-events-none" />
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="flex items-center gap-5 p-6 rounded-[2rem] bg-white hover:bg-sand-400 transition-all group/btn shadow-xl active:scale-95"
                >
                  <div className="w-14 h-14 rounded-2xl bg-teal-600 text-white flex items-center justify-center shadow-lg group-hover/btn:scale-110 transition-transform">
