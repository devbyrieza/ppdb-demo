...
const TimelineItem = ({ item, index }: { item: any; index: number }) => (
  ...
  >
    ...
    <div
      ...
      ${item.status === "active" ? "border-teal-600 text-teal-600" : "border-surface-100 text-ink-300"}`}
    >
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden bg-white">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-50/50 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-sand-50/30 rounded-full blur-[100px] -translate-x-1/2 translate-y-1/2 pointer-events-none" />
        ...
        <Container className="relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-surface-200 text-teal-700 text-xs font-black uppercase tracking-widest mb-10 shadow-premium-sm"
            >
            ...
            >
              Siapkan Generasi <br />
              <span className="text-teal-600">Terbaik Kita</span>
            </motion.h1>
            ...
            <motion.div
              ...
              className="max-w-4xl mx-auto bg-teal-50 border border-teal-100 rounded-3xl p-6 md:p-8 mb-12 flex flex-col md:flex-row items-center gap-6 text-left shadow-premium-sm"
            >
              <div className="w-16 h-16 bg-teal-600 rounded-2xl flex items-center justify-center text-white shrink-0 shadow-premium-md relative overflow-hidden">
            ...
            >
              <Link
                ...
                className="inline-flex items-center justify-center gap-3 px-10 py-5 rounded-pill bg-teal-900 text-white font-black text-xl hover:bg-teal-800 shadow-premium-lg transition-all"
              >
                Daftar PPDB Baru
              </Link>
              <a
        ...
        <Container>
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className="lg:w-2/5 lg:sticky lg:top-32 h-fit flex flex-col items-center text-center lg:items-start lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-surface-200 text-teal-700 text-xs font-black uppercase tracking-widest mb-8 shadow-premium-sm">
        ...
        <Container>
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-3xl md:text-6xl font-display font-black text-ink-950 mb-6">
              ...
              <span className="text-teal-600">Pendidikan</span>
            </h2>
            ...
            {biaya.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-8 sm:p-12 rounded-[2rem] md:rounded-[3.5rem] border border-surface-100 shadow-premium-lg flex flex-col items-center text-center group hover:bg-teal-900 transition-all duration-500"
                >
                  <div className="w-20 h-20 bg-surface-50 rounded-[2rem] flex items-center justify-center text-teal-600 mb-8 group-hover:bg-white/10 group-hover:text-white transition-all shadow-premium-sm">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-16 max-w-4xl mx-auto bg-teal-50 border border-teal-100 rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left"
          >
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-teal-600 shadow-premium-sm shrink-0">
              <HelpCircle className="w-8 h-8" />
            </div>
            <div>
              <p className="text-lg text-teal-900 font-bold leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            <div className="space-y-12">
              <h2 className="text-3xl md:text-4xl font-display font-black text-ink-950 text-center lg:text-left">
                Persyaratan{" "}
                <span className="text-teal-600">Administrasi</span>
              </h2>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4 md:gap-5 mb-6 md:mb-8">
                        <div className="w-12 h-12 md:w-14 md:h-14 bg-teal-50 rounded-2xl flex items-center justify-center text-teal-600 shadow-premium-sm shrink-0">
                      ...
                      <ul className="space-y-3 md:space-y-5">
                        {req.items.map((item, i) => (
                          ...
                          >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-ink-300 group-hover:text-teal-600 shrink-0">
                              {item.type}
                            </span>
                          </li>
                        ))}
            ...
            <div className="space-y-12 md:space-y-16">
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                className="bg-teal-900 rounded-[2rem] md:rounded-[4rem] p-6 md:p-16 text-white relative overflow-hidden shadow-premium-2xl"
              >
                      ...
                      return (
                        ...
                        >
                          <div className="w-10 h-10 md:w-12 md:h-12 bg-white/10 rounded-2xl flex items-center justify-center shrink-0">
                            <FeatIcon className="w-5 h-5 md:w-6 md:h-6 text-sand-400" />
                          </div>
                          <div>
                    ...
                    <motion.div key={i} className="group">
                      <details className="bg-white rounded-2xl border border-surface-100 shadow-premium-sm transition-all duration-300 open:shadow-premium-lg">
                        <summary className="p-5 md:p-6 flex items-center gap-4 md:gap-5 cursor-pointer list-none">
                          <div className="w-8 h-8 md:w-10 md:h-10 bg-teal-50 rounded-xl flex items-center justify-center text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-all shrink-0">
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-white">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-teal-900 bg-linear-to-br from-teal-800 to-teal-950 rounded-[2rem] md:rounded-[3rem] lg:rounded-[4rem] p-6 sm:p-8 md:p-16 lg:p-24 text-center text-white relative overflow-hidden shadow-premium-2xl"
          >
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-black mb-4 sm:mb-6 md:mb-8 text-white leading-tight">
                Mulai Perjalanan <br />{" "}
                <span className="text-sand-400">Ananda Di Sini</span>
              </h2>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-teal-100 max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 lg:mb-12 font-medium leading-relaxed px-2">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/daftar">
                  <span className="w-full sm:w-auto inline-block px-6 sm:px-8 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-teal-900 font-black text-sm sm:text-base md:text-lg xl:text-xl hover:bg-sand-400 hover:text-white shadow-premium-xl transition-all cursor-pointer min-h-[48px] sm:min-h-[52px]">
                    Daftar Sekarang
                  </span>
                </Link>
                <a
              ...
              {/* Trust microcopy */}
              <p className="mt-6 text-[11px] text-teal-300 font-bold uppercase tracking-widest">
