      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden bg-white">
        ...
        <Container className="relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              Bergabunglah dengan Pesantren Al-Andalus [Template Demo]. Lingkungan yang kondusif untuk mencetak Hafidz Qur'an yang berwawasan luas dan berakhlak mulia.
            </motion.p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-maroon-800 font-medium leading-relaxed">
                  Menjadi bagian dari angkatan 2026/2027 adalah sebuah keistimewaan. Ananda akan menjadi <strong>pionir dan tonggak sejarah pertama</strong> yang merasakan secara penuh perpaduan mantap antara sistem unggulan Al-Andalus dengan kekayaan warisan 30 tahun [Template Demo].
                </p>
              </div>
            </motion.div>
                  ...
                  {[
                    {
                      ...
                      a: "Ya, seluruh santri di Pesantren Al-Andalus [Template Demo] wajib tinggal di asrama untuk mengikuti seluruh rangkaian kegiatan tarbiyah, halaqah tahfidz, dan pembelajaran kitab turots secara maksimal."
                    },
                    {
