  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#F0F7FF] via-[#F8FAFC] to-white flex flex-col items-center justify-center p-4 sm:p-6 py-10 sm:py-16 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-5xl lg:max-w-6xl rounded-3xl overflow-hidden shadow-2xl shadow-blue-950/10 border border-slate-200 bg-white grid grid-cols-1 lg:grid-cols-12 relative z-10">
        ...
        <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#0B1528] via-[#1E3A8A] to-[#1D4ED8] p-6 sm:p-8 lg:p-10 text-white relative overflow-hidden flex flex-col justify-between">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-12 pl-4 pr-11 bg-slate-50/60 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 placeholder:font-normal placeholder:text-slate-400 focus:bg-white focus:border-[#1E3A8A] focus:ring-4 focus:ring-[#1E3A8A]/10 transition-all select-text"
                    />
                    <button
                      type="button"
                      tabIndex={-1}
